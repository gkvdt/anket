...
if (!empty(post('anket_yesorno_branch') && post('anket_yesorno_fullname') && post('anket_yesorno_country') && post('anket_yesorno_telno') && post('anket_yesorno_email') && post('anket_yesorno_answer'))) {
		...
		$insert = $query->execute([
			...
			'anket_yesorno_fullname' => post('anket_yesorno_fullname'),
			'anket_yesorno_country' => post('anket_yesorno_country'),
			'anket_yesorno_telno' => post('anket_yesorno_telno'),
			'anket_yesorno_email' => post('anket_yesorno_email'),
			'anket_yesorno_answer' => post('anket_yesorno_answer'),
			'anket_yesorno_no_answer' => post('anket_yesorno_no_answer')
		]);
    ...
    <div class="container">
        <div class="row clearfix">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label style="font-size:15px;font-weight: 500; color:#704214 !important;" for="country">Country</label><span style="color: red !important; display: inline; float: none;">*</span>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <label style="font-size:15px;font-weight: 500; color:#704214 !important;"> Enter Full Name: </label>
