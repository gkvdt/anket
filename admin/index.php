...
if (post('send')) {
    ...
    $result = $query->fetch();
    $_SESSION['admin'] = $result['admin_username'];
    if (post('admin_username') == $result['admin_username'] && post('admin_password') == $result['admin_password']) {
        $_SESSION['admin'] = $result['admin_username'];
        header("Location: panel.php");
    } else {
                ...
                <form class="form" method="post" action="" name="">
                    ...
                    <div class="content">
                        <div class="input-group">
                            <input type="mail" class="form-control" placeholder="Enter Admin Mail" name="admin_username">
